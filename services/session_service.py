...
class SessionService(Service):
    ...
    def __init__(self, env, host='localhost', port=6379, db=0, cookie_name='bottle.session', cookie_lifetime=300,
                 keyword='session', password=None):
        super(SessionService, self).__init__(env)
    ...
    def on_active(self):
        super(SessionService, self).on_active()
